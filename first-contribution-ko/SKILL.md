...
3. `CONTRIBUTING.md`와 `README.md`를 먼저 읽으세요 — 프로젝트마다 브랜치 명명 규칙, 커밋 메시지 포맷, 필수 테스트, DCO/CLA 서명 등 관례가 조금씩 다릅니다.
...
2. 메인테이너의 리뷰 피드백이 오면 빠르게 반영하되, *왜* 바뀌는지 사용자가 계속 이해하게 하세요 — 제안을 그냥 그대로 적용하지 마세요.
